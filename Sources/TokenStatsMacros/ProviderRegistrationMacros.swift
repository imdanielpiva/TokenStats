...
public struct ProviderDescriptorRegistrationMacro: PeerMacro {
        ...
        in context: some MacroExpansionContext) throws -> [DeclSyntax]
    {
        ...
        let registerName = "_TokenStatsDescriptorRegistration_\(typeName)"
        return [
            DeclSyntax(
...
public struct ProviderImplementationRegistrationMacro: PeerMacro {
        ...
        in context: some MacroExpansionContext) throws -> [DeclSyntax]
    {
        ...
        let registerName = "_TokenStatsImplementationRegistration_\(typeName)"
        return [
            DeclSyntax(
...
@main
struct TokenStatsMacroPlugin: CompilerPlugin {
