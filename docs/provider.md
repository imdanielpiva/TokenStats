...
- `Sources/TokenStatsCore`: provider descriptors + fetch strategies + probes + parsing + shared utilities.
- `Sources/TokenStats`: UI/state + provider implementations (settings/login/menu hooks only).
...
- `Sources/TokenStatsCore/Providers/<ProviderID>/`
...
- `Sources/TokenStats/Providers/<ProviderID>/`
...
Checklist:
- Add `UsageProvider` case in `Sources/TokenStatsCore/Providers/Providers.swift`.
- Create `Sources/TokenStatsCore/Providers/<ProviderID>/`:
...
- Add `Sources/TokenStats/Providers/<ProviderID>/<ProviderID>ProviderImplementation.swift`:
