...
- Cache:
  - `~/Library/Caches/TokenStats/cost-usage/claude-v1.json`

## Key files
- OAuth: `Sources/TokenStatsCore/Providers/Claude/ClaudeOAuth/*`
- Web API: `Sources/TokenStatsCore/Providers/Claude/ClaudeWeb/ClaudeWebAPIFetcher.swift`
- CLI PTY: `Sources/TokenStatsCore/Providers/Claude/ClaudeStatusProbe.swift`,
  `Sources/TokenStatsCore/Providers/Claude/ClaudeCLISession.swift`
