---
summary: "Convert macOS .icon bundles to TokenStats .icns via Scripts/build_icon.sh and ictool."
read_when:
  - Updating the TokenStats app icon or asset pipeline
...
## Script
`Scripts/build_icon.sh ICON.icon TokenStats [outdir]`
